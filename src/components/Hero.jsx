...
const Hero = () => {
  return (
    <section 
      id="home" 
      className="relative w-full h-screen flex justify-start items-center text-white px-6 sm:px-12 md:px-20 lg:px-28 xl:px-32 font-montserrat">
      ...
      <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 flex space-x-4 z-10"> 
        {socialLinks.map(({ href, icon }, index) => (
          <a 
            ...
            className="text-lg sm:text-xl bg-transparent text-white p-2 rounded-full border border-white hover:bg-white hover:text-black transition"
          >
            {icon}
          </a>
        ))}
